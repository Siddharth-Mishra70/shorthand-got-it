      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed">
            Experience our <span className="font-bold text-gray-900">precision-engine</span> analysis. 
            Type the passage below and see how our system catches every detail.
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-[#0f2167] via-[#1e3a8a] to-[#2563eb] px-8 py-5 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-white font-bold text-sm tracking-wide">
                {isTyping ? 'Typing Mode · Active Session' : 'Analysis Mode · Results Ready'}
              </span>
            </div>
            <div className="flex items-center space-x-2 text-white/80 text-xs font-black uppercase tracking-widest bg-white/10 px-3 py-1.5 rounded-lg border border-white/10">
              {isTyping ? <Zap className="w-3.5 h-3.5 animate-pulse" /> : <ClipboardCheck className="w-3.5 h-3.5" />}
              <span>{isTyping ? 'Live' : 'Verified'}</span>
            </div>
          </div>
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-4">
                  <div className="flex items-center space-x-3 text-gray-400">
                    ...
                    <span className="text-sm font-semibold italic">System ready. Waiting for input...</span>
                  </div>
                  <button
                    onClick={handleSubmit}
                    disabled={typedText.trim().length < 10}
                    className="group w-full sm:w-auto bg-[#1e3a8a] hover:bg-blue-700 disabled:bg-gray-200 disabled:cursor-not-allowed text-white font-black px-10 py-5 rounded-2xl transition-all duration-300 shadow-[0_10px_30px_rgba(30,58,138,0.3)] hover:shadow-[0_15px_40px_rgba(30,58,138,0.4)] flex items-center justify-center space-x-3 transform hover:-translate-y-1"
                  >
