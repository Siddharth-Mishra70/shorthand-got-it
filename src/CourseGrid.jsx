...
const CircularCourseCard = ({ title, type, isPremium, onTakeTest }) => (
  <div className="flex flex-col items-center group">
    <div className="relative w-48 h-48 rounded-full bg-white shadow-xl flex flex-col justify-center items-center text-center p-6 border-4 border-transparent group-hover:border-[#0d6e70] transition-all duration-300">
      ...
      <FileText className="w-8 h-8 text-[#0d6e70] mb-2" />
    ...
    <button
      onClick={onTakeTest}
      className="mt-6 bg-[#0d6e70] hover:bg-blue-800 text-white px-8 py-2.5 rounded-full font-black text-xs uppercase tracking-widest shadow-lg transition-transform transform hover:scale-105 active:scale-95 flex items-center space-x-2"
    >
