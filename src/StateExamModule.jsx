...
import { ArrowLeft, Map, ChevronRight, Scale, Edit2, Headphones, BookOpen, FileText, Search, X, Lock } from 'lucide-react';
                            ...
                            {paginatedList.map((test, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Icon */}
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isLockedForUser ? 'bg-gray-200' : 'bg-blue-50'}`}>
                                            {isLockedForUser ? <Lock className="w-5 h-5 text-gray-500" /> : <ModuleIcon className="w-5 h-5 text-[#0d6e70]" />}
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                                                ...
                                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${isLockedForUser ? 'bg-gray-200 text-gray-500' : 'bg-blue-50 text-blue-600'}`}>{selectedModule.label}</span>
